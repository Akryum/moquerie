...
<template>
  <div class="flex h-full overflow-auto">
    <div class="bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-500 border border-rose-200/30 dark:border-rose-900/20 rounded-lg p-4 flex flex-col gap-2 max-w-full m-auto">
      ...
      <div
        v-if="error.data?.stack" class="border-t border-rose-500/50 w-full text-xs [&>pre]:break-all [&>pre]:whitespace-pre-wrap [&_.stack:not(.internal):hover]:underline [&_.stack:not(.internal)]:cursor-pointer" @click="onStackClick"
