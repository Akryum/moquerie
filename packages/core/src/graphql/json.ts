// Forked from https://github.com/taion/graphql-type-json/blob/10418fa03875947140d1c0bd8b8de51926252e35/src/index.js
...
export const GraphQLJSON = new GraphQLScalarType({
  ...
  serialize: (value) => {
    // ADDED auto convert to object from string typed in the DB UI
